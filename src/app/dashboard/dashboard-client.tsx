  ...
  const NavContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="space-y-2 flex-grow">
        ...
        <Button variant="ghost" className="w-full justify-start" size="lg" onClick={() => router.push('/dashboard/historial')}>
        ...
        <Button variant="ghost" className="w-full justify-start" size="lg" onClick={() => router.push('/dashboard/ayuda')}>
